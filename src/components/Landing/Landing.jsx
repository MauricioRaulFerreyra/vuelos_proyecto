    ...
    <>
      <div className={s.fondo}>
        <h1 className={s.titulo}>
          {t("header.titulo")}
          <span className={s.url}>{t("header.url")}</span>
        </h1>
        {showLoading && (
          <div style={{ marginTop: "-8.2rem" }}>
            {" "}
            <Loading />{" "}
          </div>
        )}
        ...
        <div className={s.containerPrincipal}>
            ...
            <FormControl>
              ...
              >
                <FormControlLabel
                  ...
                  sx={{ marginLeft: ".15rem", marginTop: ".8rem" }}
                />
                <FormControlLabel
                  value={false}
                  control={<Radio />}
                  ...
                  sx={{ marginLeft: "6.5rem", marginTop: "-48px" }}
                />
              </RadioGroup>
            </FormControl>
          ...
          <FormControlLabel
            ...
            control={<Checkbox onChange={handleChangeCheck} />}
