...
function PassengersInfo({ setShowPayment }) {
  ...
  function handleNextPassenger() {
    if (
      ...
      setPassengers([...passengers, input]);
        ...
        <div className={s.travellers}>
          ...
          <div className={s.container}>
            {passengers.length < pass ? (
              <>
                <label className={s.pasajero}>
                  {t("passengersInfo.pasajero")} {passengers.length + 1}
                </label>
                <div className={s.nombre}>{t("passengersInfo.n")}</div>
                <input
                  type="text"
                  className={s.input}
                  placeholder={t("passengersInfo.ph")}
                  value={input.name}
                  name="name"
